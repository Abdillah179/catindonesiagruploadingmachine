        ...
        <div class="row">
            ...
            <div id="sidebar" class="col-md-2 sidebar d-none d-md-block">
                ...
                <nav class="nav flex-column">
                    <a class="nav-link active" href="/DashboardPPICPlant3">Dashboard</a>
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <h2 class="mb-4 judul-h2">Dashboard</h2>
                <!-- Konten card tetap sama -->

                <div class="row row-card">
                    <div class="col-md-4">
                        <a href="/pilihopsilihatdataloadingmachineplant1/plant3" style="text-decoration: none">
                            <div class="card">
                                <div class="card-body">
                    ...
                    <div class="col-md-4">
                        <a href="/pilihopsilihatdataloadingmachineplant2/plant3" style="text-decoration: none">
                            <div class="card">
                                <div class="card-body">
                                    <span class="card-icon">📁</span>
                    ...
                    <div class="col-md-4">
                        <a href="/pilihopsilihatdataloadingmachineplant3/pln3" style="text-decoration: none">
                            <div class="card">
                                <div class="card-body">
                                    <span class="card-icon">📁</span>
                                    <span>Data Loading Machine Plant 3</span>
                                </div>
                            </div>
                        </a>
                    </div>
                    @can('ppicplant3gate')
                    <div class="col-md-4">
                        <a href="/tambahdataloadingmachineplant3/pln3" style="text-decoration: none">
                            <div class="card">
                                <div class="card-body">
                                    <span class="card-icon">📁</span>
                                    <span>Tambah Data Loading Machine</span>
                                </div>
                            </div>
                        </a>
                    </div>
...
<script>
    ...
    @if(session('PostLoginUserPPICPlant3Berhasil'))
        document.addEventListener('DOMContentLoaded', function() {
