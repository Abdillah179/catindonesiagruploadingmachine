        ...
        <div class="row">
            ...
            <div id="sidebar" class="col-md-2 sidebar d-none d-md-block">
                ...
                <nav class="nav flex-column">
                    ...
                    @can('ppicplant3gate')
                    <a class="nav-link active" href="/tambahdataloadingmachineplant3/pln3">Tambah Data Loading Machine</a>
                    @endcan
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <h2 class="mb-4 judul-h2 mt-3">Tambah Loading Machine Plant 3</h2>
                ...
                <div class="row row-card">
                    ...
                    @if(session('PostTambahLoadingMesinSistemPlant3PLNT3'))
                   <div class="col-12 col-md-8 col-lg-12 mb-4">
                    <div class="alert alert-primary alert-dismissible fade show" role="alert">
                        <strong>{{ session('PostTambahLoadingMesinSistemPlant3PLNT3') }}</strong>
                   ...
                   @endif
                    ...
                    <div class="col-12 col-md-8 col-lg-12 mb-4">
                        <form action="/posttambahloadingmesinsistemplant3/plnt3" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            ...
                            <div class="row mb-3">
                                <label for="targetfinish" class="col-sm-3 col-form-label form-label">Target Finish SPK</label>
                                <div class="col-sm-9">
