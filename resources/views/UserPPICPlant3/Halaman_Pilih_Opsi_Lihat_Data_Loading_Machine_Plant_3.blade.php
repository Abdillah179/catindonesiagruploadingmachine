    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <h2 class="mb-4 judul-h2">Pilih Opsi Lihat Data Loading Machine</h2>
                <!-- Konten card tetap sama -->

                <div class="row row-card">
                   <div class="col-12 col-md-8 col-lg-12 mb-4">
                        <form action="/getpilihopsilihatdataloadingmachineplant3" method="GET">

                            <select class="form-select" aria-label="Default select example" name="pilih_opsi_lihat_data_loading_machine_plnt_3">
