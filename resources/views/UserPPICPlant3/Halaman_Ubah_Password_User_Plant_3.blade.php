        ...
        <div class="row">
            ...
            <div id="sidebar" class="col-md-2 sidebar d-none d-md-block">
                ...
                <nav class="nav flex-column">
                    ...
                    @can('ppicplant3gate')
                    <a class="nav-link active" href="/ubahpassworduserplant3/pl3">Ubah Password User</a>
                    @endcan
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <h2 class="mb-4 judul-h2">Ubah Password User</h2>
                ...
                <div class="row row-card">
                    ...
                    <div class="col-12 col-md-8 col-lg-12 mb-4">
                        <form action="/postubahpassworduserplant3/pln3" method="post">
                            @csrf 
                            @method('PATCH')

                            <div class="mb-3">
                                <label for="exampleFormControlPassword" class="form-label">Password Baru</label>
                                <input type="password" class="form-control" id="exampleFormControlPassword" name="password">
                            </div>
                            <div class="mb-3">
                                <label for="exampleFormControlPasswordConfirmation" class="form-label">Confirm Password</label>
                                <input type="password" class="form-control" id="exampleFormControlPasswordConfirmation" name="password_confirmation">
                            </div>
