            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                @endif
                    ...
                    <div class="col-12 mb-5">
                        <div class="card">
                            <div class="card-header">
                                <form action="/lihatdatafileprojekloadingmachinekeseluruhanplant3/plnt3/{{ $data->url_unique }}">
                    ...
                    <div class="col-md-12">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalTambahDataFileProjekLoadingMesinKeseluruhanPlant3PLNT3">
                            Tambah File Projek
                        </button>
                        
                        <!-- Modal -->
                        <div class="modal fade" id="exampleModalTambahDataFileProjekLoadingMesinKeseluruhanPlant3PLNT3" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/posttambahdatafileprojekloadingmesinkeseluruhanplant3/plnt3/{{ $data->url_unique }}" method="POST" enctype="multipart/form-data">
                                            @csrf 
                                            @method('POST')
                    ...
                    <div class="col-12 col-md-8 col-lg-12">
                        ...
                        <div class="image-container">
                            ...
                            <div class="image mb-5 mt-2">
                                <form action="/postdeletedatafileprojekloadingmachinekeseluruhanplant3/plant3/{{ $dtfileprojek->url_unique }}" method="post" class="d-inline">
                                    @csrf
                                    @method('DELETE')
                                ...
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalUbahDataFileProjekLoadingMachineKeseluruhanPlant3PLN3{{ $dtfileprojek->url_unique }}" style="margin-bottom: 60px;">
                                    Ubah File
                                </button>
                                
                                <!-- Modal -->
                                <div class="modal fade" id="exampleModalUbahDataFileProjekLoadingMachineKeseluruhanPlant3PLN3{{ $dtfileprojek->url_unique }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                <form action="/postubahdatafileprojekloadingmachinekeseluruhanplant3/plant3/{{ $dtfileprojek->url_unique }}" method="post" enctype="multipart/form-data">
                                                    @csrf 
                                                    @method('PATCH')
