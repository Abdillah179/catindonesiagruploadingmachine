    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <h2 class="mb-4 judul-h2">Data loading machine plant 1</h2>
                <!-- Konten card tetap sama -->

                <div class="row row-card">
                    @foreach($datamesin as $dtmesin)
                    <div class="col-md-4">
                        <a href="/lihatdetaildataloadingmachinepermachineplant1/plant3/{{ $dtmesin->url_unique_mesin }}" style="text-decoration: none">
                            <div class="card">
                                <div class="card-body">
                                    <span class="card-icon">⚙️</span>
                                    <span>Data Loading Machine {{ $dtmesin->nama_mesin }}</span>
                                </div>
                            </div>
                        </a>
                    </div>
