    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <h2 class="mb-4 judul-h2">File Projek Loading Machine</h2>
                ...
                @if(session()->has('PostTambahDataFileProjekLoadingMesinKeseluruhanPlant3PLN3'))
                <div class="col-12">
                    <div class="alert alert-primary alert-dismissible fade show" role="alert">
                        <strong>{{ session('PostTambahDataFileProjekLoadingMesinKeseluruhanPlant3PLN3') }}</strong>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                </div>
                @endif

                @if(session()->has('PostDeleteDataFileProjekLoadingMachineKeseluruhanPlant3PLANT3'))
                <div class="col-12">
                    <div class="alert alert-primary alert-dismissible fade show" role="alert">
                        <strong>{{ session('PostDeleteDataFileProjekLoadingMachineKeseluruhanPlant3PLANT3') }}</strong>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                </div>
                @endif

                @if(session()->has('PostUbahDataFileProjekLoadingMachineKeseluruhanPlant3PLN3'))
                <div class="col-12">
                    <div class="alert alert-primary alert-dismissible fade show" role="alert">
                        <strong>{{ session('PostUbahDataFileProjekLoadingMachineKeseluruhanPlant3PLN3') }}</strong>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                </div>
                @endif

                @if(session()->has('PostTambahDataFileProjekLoadingMesinPerMesinPlant3PLNT3'))
                <div class="col-12">
                    <div class="alert alert-primary alert-dismissible fade show" role="alert">
                        <strong>{{ session('PostTambahDataFileProjekLoadingMesinPerMesinPlant3PLNT3') }}</strong>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                </div>
                @endif

                @if(session()->has('PostDeleteDataFileProjekLoadingMachinePerMachinePlant3PLNT3'))
                <div class="col-12">
                    <div class="alert alert-primary alert-dismissible fade show" role="alert">
                        <strong>{{ session('PostDeleteDataFileProjekLoadingMachinePerMachinePlant3PLNT3') }}</strong>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                </div>
                @endif

                @if(session()->has('PostUbahDataFileProjekLoadingMachinePerMachinePlant3PLNT3'))
                <div class="col-12">
                    <div class="alert alert-primary alert-dismissible fade show" role="alert">
                        <strong>{{ session('PostUbahDataFileProjekLoadingMachinePerMachinePlant3PLNT3') }}</strong>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                </div>
                @endif
                    ...
                    <div class="col-12 mb-5">
                        <div class="card">
                            <div class="card-header">
                                <form action="/lihatdatafileprojekloadingmachinepermachineplant3/pln3/{{ $data->url_unique }}">
                    ...
                    <div class="col-md-6 mb-3">
                        <h5>Jumlah Data : {{ $datafileprojekcount }}</h5>
                    </div>
                    
                    <div class="col-md-12">
                        <!-- Button trigger modal -->
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalTambahDataFileProjekLoadingMesinPerMesinPlant3PLN3">
                            Tambah File Projek
                        </button>
                        
                        <!-- Modal -->
                        <div class="modal fade" id="exampleModalTambahDataFileProjekLoadingMesinPerMesinPlant3PLN3" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/posttambahdatafileprojekloadingmesinpermesinplant3/plant3/{{ $data->url_unique }}" method="POST" enctype="multipart/form-data">
                                            @csrf 
                                            @method('POST')
                    ...
                    <div class="col-12 col-md-8 col-lg-12">
                        ...
                        <div class="image-container">
                            ...
                            <div class="image mb-5 mt-2">
                                <form action="/postdeletedatafileprojekloadingmachinepermachineplant3/plnt3/{{ $dtfileprojek->url_unique }}" method="post" class="d-inline">
                                    @csrf
                                    @method('DELETE')
                                ...
                                <!-- Button trigger modal -->
                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalUbahDataFileProjekLoadingMachinePerMachinePlant3PLNT3{{ $dtfileprojek->url_unique }}" style="margin-bottom: 60px;">
                                    Ubah File
                                </button>
                                
                                <!-- Modal -->
                                <div class="modal fade" id="exampleModalUbahDataFileProjekLoadingMachinePerMachinePlant3PLNT3{{ $dtfileprojek->url_unique }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                <form action="/postubahdatafileprojekloadingmachinepermachineplant3/pl3/{{ $dtfileprojek->url_unique }}" method="post" enctype="multipart/form-data">
                                                    @csrf 
                                                    @method('PATCH')
