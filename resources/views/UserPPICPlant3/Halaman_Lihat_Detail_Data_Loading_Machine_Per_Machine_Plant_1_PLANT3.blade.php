    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <h2 class="mb-4 judul-h2">Detail Data Loading Mesin {{ $mesin->nama_mesin }} Plant 1</h2>
                    ...
                    <div class="col-12 mb-5">
                        <div class="card">
                            <div class="card-header">
                                <form action="/lihatdetaildataloadingmachinepermachineplant1/plant3/{{ $mesin->url_unique_mesin }}">
                                    ...
                                    <div class="row align-items-end mt-3">
                                        ...
                                        <div class="col-md-2 mb-3">
                                            ...
                                            <a href="/lihatdetaildataloadingmachinepermachineplant1/plant3/{{ $mesin->url_unique_mesin }}" class="btn btn-warning mt-4">Clear</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div class="container">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    @foreach($dataloadingmesinplant1 as $index => $dtloadingmesin)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($datafileprojek)
                                                ...
                                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalLihatDataFileProjekLoadingMachinePerMachinePlant1PLANT3{{ $dtloadingmesin->url_unique }}">
                                                    Lihat File Projek
                                                </button>
                                                
                                                <!-- Modal -->
                                                <div class="modal fade" id="exampleModalLihatDataFileProjekLoadingMachinePerMachinePlant1PLANT3{{ $dtloadingmesin->url_unique }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script>
    ...
    function exportPDF() {
        ...
        let url = "/exportpdfdatadetailloadingmachineplant1/plant3/{{ $mesin->url_unique_mesin }}";
...
<script>
    function exportExcel() {
        ...
        let endDate = document.querySelector('input[name="end_date"]').value; // Ganti dengan selector yang sesuai
        let statusFilter = document.querySelector('select[name="opsi_filter"]').value; // Ganti dengan selector yang sesuai
        let url = "/exportexceldatadetailloadingmachineplant1/plant3/{{ $mesin->url_unique_mesin }}";
