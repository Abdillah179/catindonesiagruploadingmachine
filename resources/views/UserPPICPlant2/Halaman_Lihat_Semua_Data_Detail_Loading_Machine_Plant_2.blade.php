...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <h2 class="mb-4">Data Loading Machine {{ $mesin->nama_mesin }}</h2>
                ...
                <div class="row row-card">
                    ...
                    @if(session('PostDeleteLoadingMachinePlant2PLN2'))
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            <strong>{{ session('PostDeleteLoadingMachinePlant2PLN2') }}</strong>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    @endif

                    @if(session('PostDeleteLoadingMachinePlant2PLN2Gagal'))
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            <strong>{{ session('PostDeleteLoadingMachinePlant2PLN2Gagal') }}</strong>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    @endif

                    @if(session('UpdateStatusDoneDataLoadingMachinePlant2PLN2'))
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            <strong>{{ session('UpdateStatusDoneDataLoadingMachinePlant2PLN2') }}</strong>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    @endif

                    @if(session('PostUbahDataDetailLoadingMesinSPKPlant2PLN2'))
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            <strong>{{ session('PostUbahDataDetailLoadingMesinSPKPlant2PLN2') }}</strong>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    @endif
                    
                    @if(session('PostTambahDataFileProjekLoadingMachinePerMachinePlant2PLANT2'))
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            <strong>{{ session('PostTambahDataFileProjekLoadingMachinePerMachinePlant2PLANT2') }}</strong>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    @endif
                    ...
                    <div class="col-12 mb-5">
                        <div class="card">
                            <div class="card-header">
                                <form action="/lihatsemuadatadetailloadingmachineplant2/pln2/{{ $mesin->url_unique_mesin }}">
                                    ...
                                    <div class="row align-items-end mt-3">
                                        ...
                                        <div class="col-md-2 mb-3">
                                            ...
                                            <a href="/lihatsemuadatadetailloadingmachineplant2/pln2/{{ $mesin->url_unique_mesin }}" class="btn btn-warning mt-4">Clear</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                   ...
                   <div class="col-12 col-md-8 col-lg-12 mb-4 mx-auto" style="max-width: 2000px">
                    <div class="container">
                        <div class="header">
                            <h1>📋 Loading Mesin</h1>
                            <div class="export2 mt-2">
                                Jumlah Data : {{ $dataloadingmesincount }}
                            </div>
                            <div class="export">
                                <button onclick="exportPDF()" class="btn btn-danger btn-sm mt-3">Export PDF</button>
                                <button onclick="exportExcel()" class="btn btn-success btn-sm mt-3">Export Excel</button>
                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    @foreach($dataloadingmachine as $index => $dtloadingmesin)
                                    <tr>
                                        <td>{{ $dataloadingmachine->firstItem() + $index }}</td>
                                        ...
                                        <td>
                                            ...
                                            @if($datafileprojek)
                                                ...
                                                <a href="/lihatdatafileprojekloadingmachinepermachineplant2/plnt2/{{ $dtloadingmesin->url_unique }}" class="btn btn-primary btn-sm">Lihat File Projek</a>
                                            @else

                                                <!-- Button trigger modal -->
                                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalTambahDataFileProjekLoadingMachinePerMachinePlant2PLNT2{{ $dtloadingmesin->url_unique }}">
                                                    Tambah File Projek
                                                </button>
                                                
                                                <!-- Modal -->
                                                <div class="modal fade" id="exampleModalTambahDataFileProjekLoadingMachinePerMachinePlant2PLNT2{{ $dtloadingmesin->url_unique }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="/posttambahdatafileprojekloadingmachinepermachineplant2/plnt2/{{ $dtloadingmesin->url_unique }}" method="post" enctype="multipart/form-data">
                                                                @csrf 
                                                                @method('POST')
                                        ...
                                        @elseif(!$dtloadingmesin->user_pengupdated_status_done_loading_mesin && !$dtloadingmesin->departemen_user_pengupdated_status_done_loading_mesin && !$dtloadingmesin->plant_user_pengupdated_status_done_loading_mesin && !$dtloadingmesin->tanggal_updated_status_done_loading_mesin && !$dtloadingmesin->jam_updated_status_done_loading_mesin)
                                        <td></td>
                                        @endif
                                        ...
                                        @can('ppicplant2gate')
                                        <td>
                                            <form action="/postdeleteloadingmachineplant2/pln2/{{ $dtloadingmesin->url_unique }}" method="post" class="d-inline">
                                                @csrf 
                                                @method('DELETE')

                                                <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin ingin menghapus data loading machine ini ??')">Hapus</button>
                                            </form>

                                            <form action="/updatestatusdonedataloadingmachineplant2/pln2/{{ $dtloadingmesin->url_unique }}" method="post" class="d-inline">
                                                @csrf 
                                                @method('PATCH')
                                            ...
                                            <!-- Button trigger modal -->
                                            <button type="button" class="btn btn-primary btn-sm mt-3" data-bs-toggle="modal" data-bs-target="#exampleModalEditDataLoadingMesinSPKPlant1PLN1{{ $dtloadingmesin->url_unique }}">
                                                Edit/Ubah Data Loading Machine
                                            </button>
                                            
                                            <!-- Modal -->
                                            <div class="modal fade" id="exampleModalEditDataLoadingMesinSPKPlant1PLN1{{ $dtloadingmesin->url_unique }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Ubah Data Loading Machine</h1>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form action="/postubahdatadetailloadingmesinspkplant2/pln2/{{ $dtloadingmesin->url_unique }}" method="post">
                                                            @csrf
                                                            @method('PATCH')
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" class="form-control" id="Plant" name="plant" value="{{ $dtloadingmesin->plant }}" readonly>
                                                                </div>
                                                            </div>
                                
                                                            <div class="row mb-3">
                                                                <label for="mesin" class="col-sm-3 col-form-label form-label">Mesin</label>
                                                                <div class="col-sm-9">
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" class="form-control" id="Customer" name="customer" value="{{ $dtloadingmesin->customer }}" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="row mb-3">
                                                                <label for="nospk" class="col-sm-3 col-form-label form-label">No. SPK</label>
                                                                <div class="col-sm-9">
                                                                    <input type="text" class="form-control" id="nospk" name="no_spk" value="{{ $dtloadingmesin->no_spk }}" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="row mb-3">
                                                            ...
                                                            <div class="row mb-3">
                                                                <label for="start" class="col-sm-3 col-form-label form-label">Tanggal Pengerjaan</label>
                                                                <div class="col-sm-9">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-9 offset-sm-3 text-small">
                                                                    <small class="text-muted">*Sebelum mengupdated loading machine, pastikan data yang anda inputkan sudah benar dan sesuai</small>
                                                                </div>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
    ...
    function exportPDF() {
        let searchQuery = document.querySelector('input[name="search"]').value;
            ...
            let url = "/export-pdf-detail-loading-machine-plant-2/{{ $mesin->url_unique_mesin }}";
...
<script>
    function exportExcel() {
        let searchQuery = document.querySelector('input[name="search"]').value;
            ...
            let endDate = document.querySelector('input[name="end_date"]').value; // Ganti dengan selector yang sesuai
            let statusFilter = document.querySelector('select[name="opsi_filter"]').value; // Ganti dengan selector yang sesuai
            let url = "/export-excel-detail-loading-machine-plant-2/{{ $mesin->url_unique_mesin }}";
