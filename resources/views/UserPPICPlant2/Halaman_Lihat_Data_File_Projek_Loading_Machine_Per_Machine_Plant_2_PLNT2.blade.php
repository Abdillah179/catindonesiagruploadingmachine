        ...
        <div class="row">
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <div class="row row-card">
                    ...
                    @if(session()->has('PostTambahDataFileProjekLoadingMesinPerMesinPlant2PLANT2'))
                    <div class="col-12">
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            <strong>{{ session('PostTambahDataFileProjekLoadingMesinPerMesinPlant2PLANT2') }}</strong>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    </div>
                    @endif

                    @if(session()->has('PostDeleteDataFileProjekLoadingMachinePerMachinePlant2PLNT2'))
                    <div class="col-12">
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            <strong>{{ session('PostDeleteDataFileProjekLoadingMachinePerMachinePlant2PLNT2') }}</strong>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    </div>
                    @endif

                    @if(session()->has('PostUbahDataFileProjekLoadingMachinePerMachinePlant2PLNT2'))
                    <div class="col-12">
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            <strong>{{ session('PostUbahDataFileProjekLoadingMachinePerMachinePlant2PLNT2') }}</strong>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="col-12 mb-5">
                        <div class="card">
                            <div class="card-header">
                                <form action="/lihatdatafileprojekloadingmachinepermachineplant2/plnt2/{{ $data->url_unique }}">
                    ...
                    <div class="col-md-12">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalTambahDataFileProjekLoadingMesinPerMesinPlant2PLNT2">
                            Tambah File Projek
                        </button>
                        
                        <!-- Modal -->
                        <div class="modal fade" id="exampleModalTambahDataFileProjekLoadingMesinPerMesinPlant2PLNT2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/posttambahdatafileprojekloadingmesinpermesinplant2/plant2/{{ $data->url_unique }}" method="POST" enctype="multipart/form-data">
                                            @csrf 
                                            @method('POST')
                        ...
                        @foreach($datafileprojek as $dtfileprojek)
                            <div class="image-container">
                                ...
                                <div class="image mb-5 mt-2">
                                    <form action="/postdeletedatafileprojekloadingmachinepermachineplant2/plnt2/{{ $dtfileprojek->url_unique }}" method="post" class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    <!-- Button trigger modal -->
                                    <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalUbahDataFileProjekLoadingMachinePerMachinePlant2PLANT2{{ $dtfileprojek->url_unique }}" style="margin-bottom: 60px;">
                                        Ubah File
                                    </button>
                                    
                                    <!-- Modal -->
                                    <div class="modal fade" id="exampleModalUbahDataFileProjekLoadingMachinePerMachinePlant2PLANT2{{ $dtfileprojek->url_unique }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <form action="/postubahdatafileprojekloadingmachinepermachineplant2/plnt2/{{ $dtfileprojek->url_unique }}" method="post" enctype="multipart/form-data">
                                                        @csrf 
                                                        @method('PATCH')
