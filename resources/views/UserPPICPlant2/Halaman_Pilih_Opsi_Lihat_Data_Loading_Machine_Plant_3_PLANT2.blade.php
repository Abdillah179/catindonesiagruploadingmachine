            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <div class="row row-card">
                    <div class="col-12 col-md-8 col-lg-12">
                        <form action="/getpilihopsilihatdataloadingmesinplant3/plant2" method="GET">
                            <select class="form-select" aria-label="Default select example" name="pilih_opsi_lihat_data_loading_machine_plant_3_PLANT2">
