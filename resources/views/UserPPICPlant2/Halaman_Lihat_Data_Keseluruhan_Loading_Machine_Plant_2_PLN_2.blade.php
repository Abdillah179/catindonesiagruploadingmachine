    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <h2 class="mb-4">Halaman Lihat Data Keseluruhan Loading Machine Plant 2</h2>
                ...
                <div class="row row-card">
                    <div class="col-12 mb-5">
                        <div class="card">
                            <div class="card-header">
                                <form action="/lihatdatakeseluruhanloadingmesinplant2">
                                    ...
                                    <div class="row align-items-end mt-3">
                                        ...
                                        <div class="col-md-2 mb-3">
                                            ...
                                            <a href="/lihatdatakeseluruhanloadingmesinplant2" class="btn btn-warning mt-4">Clear</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                    ...
                    @if(session('PostEditDataKeseluruhanLoadingMachinePPICPlant2PLN2'))
                    <div class="alert alert-primary alert-dismissible fade show" role="alert">
                        <strong>{{ session('PostEditDataKeseluruhanLoadingMachinePPICPlant2PLN2') }}</strong>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    @endif

                    @if(session('PostUpdateStatusDoneDataKeseluruhanLoadingMachinePlant2PLNT2'))
                    <div class="alert alert-primary alert-dismissible fade show" role="alert">
                        <strong>{{ session('PostUpdateStatusDoneDataKeseluruhanLoadingMachinePlant2PLNT2') }}</strong>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    @endif

                    @if(session('PostDeleteDataKeseluruhanLoadingMachinePlant2'))
                    <div class="alert alert-primary alert-dismissible fade show" role="alert">
                        <strong>{{ session('PostDeleteDataKeseluruhanLoadingMachinePlant2') }}</strong>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    @endif
                    
                    @if(session('PostTambahDataFileProjekLoadingMachineKeseluruhanPlant2PLNT2'))
                    <div class="alert alert-primary alert-dismissible fade show" role="alert">
                        <strong>{{ session('PostTambahDataFileProjekLoadingMachineKeseluruhanPlant2PLNT2') }}</strong>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    @endif
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/lihatdatakeseluruhanfileprojekloadingmachineplant2/plnt2/{{ $dtloadingmesin->url_unique }}" class="btn btn-primary btn-sm">Lihat File Projek</a>

                                            @else

                                            <!-- Button trigger modal -->
                                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalTambahFileProjekLoadingMachinePlant2Keseluruhan{{ $dtloadingmesin->url_unique }}">
                                                    Tambah File Projek
                                                </button>
                                                
                                                <!-- Modal -->
                                                <div class="modal fade" id="exampleModalTambahFileProjekLoadingMachinePlant2Keseluruhan{{ $dtloadingmesin->url_unique }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="/posttambahdatafileprojekloadingmachinekeseluruhanplant2/plnt2/{{ $dtloadingmesin->url_unique }}" method="post" enctype="multipart/form-data">
                                                                @csrf 
                                                                @method('POST')
                                        ...
                                        @can('ppicplant2gate')
                                        <td>
                                            <form action="/postdeletedatakeseluruhanloadingmachineplant2/{{ $dtloadingmesin->url_unique }}" method="post" class="d-inline">
                                                @csrf 
                                                @method('DELETE')
                                             ...
                                             <!-- Button trigger modal -->
                                             <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalEditDataKeseluruhanLoadingMachineSPKPlant2PLNT2{{ $dtloadingmesin->url_unique }}">
                                                Edit Loading Machine
                                            </button>
                                            
                                            <!-- Modal -->
                                            <div class="modal fade" id="exampleModalEditDataKeseluruhanLoadingMachineSPKPlant2PLNT2{{ $dtloadingmesin->url_unique }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="/posteditdatakeseluruhanloadingmachineppicplant2/pln2/{{ $dtloadingmesin->url_unique }}" method="post" class="d-inline">
                                                            @csrf
                                                            @method('PATCH')
                                            ...
                                            <form action="/postupdatestatusdonedatakeseluruhanloadingmachineplant2/plnt2/{{ $dtloadingmesin->url_unique }}" method="post" class="d-inline">
                                                @csrf 
                                                @method('PATCH')

                                                <button type="submit" class="btn btn-primary btn-sm mt-1">Update Status Done Loading Machine</button>
                                            </form>
                                        </td>
                                        @endcan
                                    </tr>
...
<script>
    function exportPDF() {
        let searchQuery = document.querySelector('input[name="search"]').value;
            ...
            let url = "/export-pdf-data-keseluruhan-loading-machine-plant-2";
...
<script>
    function exportExcel() {
        let searchQuery = document.querySelector('input[name="search"]').value;
            ...
            let endDate = document.querySelector('input[name="end_date"]').value; // Ganti dengan selector yang sesuai
            let statusFilter = document.querySelector('select[name="opsi_filter"]').value; // Ganti dengan selector yang sesuai
            let url = "/export-excel-data-keseluruhan-loading-machine-plant-2";
