    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <h2 class="mb-4">Halaman Lihat Data Keseluruhan Loading Machine Plant 1</h2>
                    ...
                    <div class="col-12 mb-5">
                        <div class="card">
                            <div class="card-header">
                                <form action="/lihatdatakeseluruhanloadingmachineplant1/plant2">
                                    ...
                                    <div class="row align-items-end mt-3">
                                        ...
                                        <div class="col-md-2 mb-3">
                                            ...
                                            <a href="/lihatdatakeseluruhanloadingmachineplant1/plant2" class="btn btn-warning mt-4">Clear</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($datafileprojek)
                                                ...
                                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalLihatDataFileProjekLoadingMachineKeseluruhanPlant1PLANT2{{ $dtloadingmesin->url_unique }}">
                                                    Lihat File Projek
                                                </button>
                                                
                                                <!-- Modal -->
                                                <div class="modal fade" id="exampleModalLihatDataFileProjekLoadingMachineKeseluruhanPlant1PLANT2{{ $dtloadingmesin->url_unique }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-scrollable modal-xl">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="exampleModalLabel">File Projek Loading Machine Plant 1</h1>
...
<script>
    ...
    function exportPDF() {
        let searchQuery = document.querySelector('input[name="search"]').value;
            ...
            let url = "/export-pdf-data-keseluruhan-loading-machine-plant-1/plant2";
...
<script>
    function exportExcel() {
        let searchQuery = document.querySelector('input[name="search"]').value;
            ...
            let endDate = document.querySelector('input[name="end_date"]').value; // Ganti dengan selector yang sesuai
            let statusFilter = document.querySelector('select[name="opsi_filter"]').value; // Ganti dengan selector yang sesuai
            let url = "/export-excel-data-keseluruhan-loading-machine-plant-1/plant2";
