...
<body>
        ...
        <div class="row">
            ...
            <div id="sidebar" class="col-md-2 sidebar d-none d-md-block">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link active" href="/pilihopsilihatdataloadingmachineplant1/plnt2">Lihat Data Loading Machine Plant 1</a>
                    ...
                    <div class="col-12 mb-5">
                        <div class="card">
                            <div class="card-header">
                                <form action="/lihatsemuadatadetailloadingmesinpermesinplant1/plant2/{{ $mesin->url_unique_mesin }}">
                                    ...
                                    <div class="row align-items-end mt-3">
                                        ...
                                        <div class="col-md-2 mb-3">
                                            ...
                                            <a href="/lihatsemuadatadetailloadingmesinpermesinplant1/plant2/{{ $mesin->url_unique_mesin }}" class="btn btn-warning mt-4">Clear</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <!-- Button trigger modal -->
                                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalLihatDataFileProjekLoadingMachinePerMachinePlant1PLNT2{{ $dtloadingmesin->url_unique }}">
                                                    Lihat File Projek
                                                </button>
                                                
                                                <!-- Modal -->
                                                <div class="modal fade" id="exampleModalLihatDataFileProjekLoadingMachinePerMachinePlant1PLNT2{{ $dtloadingmesin->url_unique }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-xl modal-dialog-scrollable">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                @foreach($dtloadingmesin->fileProjek as $dtfileprojek)
    ...
    function exportPDF() {
        let searchQuery = document.querySelector('input[name="search"]').value;
            ...
            let url = "/export-pdf-detail-loading-machine-plant-1-per-machine/plant2/{{ $mesin->url_unique_mesin }}";
...
<script>
    function exportExcel() {
        let searchQuery = document.querySelector('input[name="search"]').value;
            ...
            let endDate = document.querySelector('input[name="end_date"]').value; // Ganti dengan selector yang sesuai
            let statusFilter = document.querySelector('select[name="opsi_filter"]').value; // Ganti dengan selector yang sesuai
            let url = "/export-excel-detail-loading-machine-plant-1-per-machine/plant2/{{ $mesin->url_unique_mesin }}";
