...
<body>
        ...
        <div class="row">
            ...
            <div id="sidebar" class="col-md-2 sidebar d-none d-md-block">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link active" href="/pilihopsilihatdataloadingmachineplant3/plant2">Lihat Data Loading Machine Plant 3</a>
                </nav>
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <h2 class="mb-4">Data Loading Machine {{ $mesin->nama_mesin }} Plant 3</h2>
                    ...
                    <div class="col-12 mb-5">
                        <div class="card">
                            <div class="card-header">
                                <form action="/lihatsemuadatadetailloadingmachinepermachineplant3/plant2/{{ $mesin->url_unique_mesin }}">
                                    ...
                                    <div class="row align-items-end mt-3">
                                        ...
                                        <div class="col-md-2 mb-3">
                                            ...
                                            <a href="/lihatsemuadatadetailloadingmachinepermachineplant3/plant2/{{ $mesin->url_unique_mesin }}" class="btn btn-warning mt-4">Clear</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($datafileprojek)
                                                ...
                                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalLihatDataFileProjekLoadingMachinePerMachinePlant3PLN2{{ $dtloadingmesin->url_unique }}">
                                                    Lihat File Projek
                                                </button>
                                                
                                                <!-- Modal -->
                                                <div class="modal fade" id="exampleModalLihatDataFileProjekLoadingMachinePerMachinePlant3PLN2{{ $dtloadingmesin->url_unique }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <script>
        function exportPDF() {
            ...
            let url = "/export-pdf-detail-loading-machine-plant-3-per-machine/plant2/{{ $mesin->url_unique_mesin }}";
   ...
   <script>
        function exportExcel() {
            ...
            let endDate = document.querySelector('input[name="end_date"]').value; // Ganti dengan selector yang sesuai
            let statusFilter = document.querySelector('select[name="opsi_filter"]').value; // Ganti dengan selector yang sesuai
            let url = "/export-excel-detail-loading-machine-plant-3-per-machine/plant2/{{ $mesin->url_unique_mesin }}";
