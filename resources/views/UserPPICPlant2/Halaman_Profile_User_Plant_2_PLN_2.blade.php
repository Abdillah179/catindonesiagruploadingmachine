...
<body>
        ...
        <div class="row">
            ...
            <div id="sidebar" class="col-md-2 sidebar d-none d-md-block">
                ...
                <nav class="nav flex-column">
                    ...
                    @can('ppicplant2gate')
                    <a class="nav-link active" href="/profileuserplant2/pln2">Profile User</a>
                    @endcan
                                ...
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body" style="text-align: left">
                                        <form action="/postubahfotoprofileuserplant2/plnt2" method="post" enctype="multipart/form-data">
                                            @csrf 
                                            @method('PATCH')
    ...
    <script>
        ...
        $('#takefotouser').click(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '/postgetfotoprofileuserplant2',
                data: {
                    _token: '{{ csrf_token() }}',
                    image: image
                },
                ...
                success: function(respond) {
                    if (respond == 1) {
                        ...
                        setTimeout("location.href='/profileuserplant2/pln2'", 3000);
                    } else {
