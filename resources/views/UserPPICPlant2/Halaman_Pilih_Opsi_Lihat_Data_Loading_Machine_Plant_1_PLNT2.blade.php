    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <h2 class="mb-4">Pilih Opsi Lihat Data Loading Machine Plant 1</h2>
                <!-- Konten card tetap sama -->

                <div class="row row-card">
                    <div class="col-12 col-md-8 col-lg-12">
                        <form action="/getpilihopsilihatdataloadingmesinplant1/plant2" method="GET">
                            <select class="form-select" aria-label="Default select example" name="pilih_opsi_lihat_data_loading_machine_plant_1_PLANT2">
