    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <h2 class="mb-4">Halaman Lihat Data Keseluruhan Loading Machine Plant 3</h2>
                ...
                <div class="row row-card">
                    <div class="col-12 mb-5">
                        <div class="card">
                            <div class="card-header">
                                <form action="/lihatdatakeseluruhanloadingmesinplant3/plant2">
                                    ...
                                    <div class="row align-items-end mt-3">
                                        ...
                                        <div class="col-md-2 mb-3">
                                            ...
                                            <a href="/lihatdatakeseluruhanloadingmesinplant3/plant2" class="btn btn-warning mt-4">Clear</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                   ...
                   <div class="col-12 col-md-8 col-lg-12 mb-4 mx-auto" style="max-width: 2000px;">
                    <div class="container">
                        ...
                        <div class="info">
                            <div class="info-item">Jumlah Data : {{ $dataloadingmesinplant3count }}</div>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    @foreach($dataloadingmesinplant3 as $index => $dtloadingmesin)
                                    <tr>
                                        <td>{{ $dataloadingmesinplant3->firstItem() + $index }}</td>
                                        ...
                                        <td>
                                            ...
                                            @if($datafileprojek)
                                                ...
                                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalLihatDataKeseluruhanFileProjekLoadingMachinePlant3PLANT2{{ $dtloadingmesin->url_unique }}">
                                                    Lihat File Projek
                                                </button>
                                                
                                                <!-- Modal -->
                                                <div class="modal fade" id="exampleModalLihatDataKeseluruhanFileProjekLoadingMachinePlant3PLANT2{{ $dtloadingmesin->url_unique }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script>
    function exportPDF() { 
        ...
        let url = "/export-pdf-data-keseluruhan-loading-machine-plant-3/plant2";
...
<script>
    function exportExcel() {
        ...
        let endDate = document.querySelector('input[name="end_date"]').value; // Ganti dengan selector yang sesuai
        let statusFilter = document.querySelector('select[name="opsi_filter"]').value; // Ganti dengan selector yang sesuai
        let url = "/export-excel-data-keseluruhan-loading-machine-plant-3/plant2";
