        ...
        <div class="row">
            ...
            <div id="sidebar" class="col-md-2 sidebar d-none d-md-block">
                ...
                <nav class="nav flex-column">
                    ...
                    @can('ppicplant2gate')
                    <a class="nav-link active" href="/ubahpassworduserplant2/pln2">Ubah Password User</a>
                    @endcan 
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <h2 class="mb-4">Ubah Password User</h2>
                ...
                @endif
                    <div class="col-12 col-md-8 col-lg-12 mb-4">
                        <form action="/postubahpassworduserplant2/pln2" method="post">
                            @csrf 
                            @method('PATCH')
