        ...
        <div class="row">
            ...
            <div id="sidebar" class="col-md-2 sidebar d-none d-md-block">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link active" href="/lihatdataspkbagianppicplant3">Lihat Data SPK Terkirim Dari Admin</a>
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <h2 class="mb-4 judul-h2">Tambah Loading Machine SPK Plant 1</h2>
                ...
                <div class="row row-card">
                    ...
                    <div class="col-12 col-md-8 col-lg-12 mb-4">
                        <form action="/posttambahloadingmesinspkppicplant1/pt1/{{ $data->url_unique }}" method="post">
                            @csrf
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="Plant" name="plant" value="{{ $data->spk_plant }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select" aria-label="Default select example" name="nama_mesin">
                                        @foreach($datamesin as $dtmesin)

                                        <option value="{{ $dtmesin->nama_mesin }}">{{ $dtmesin->nama_mesin }}</option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select class="form-select" aria-label="Default select example" name="project" id="project">
                                        @foreach($datanamaprojek as $dtnamaprojek)
                                        <option value="{{ $dtnamaprojek->url_unique }}">{{ $dtnamaprojek->nama_project }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <label for="itemPart" class="col-sm-3 col-form-label form-label">Item Part</label>
                                <div class="col-sm-9">
                                    <select class="form-select" aria-label="Default select example" name="item_part" id="itemPart">
                                        <option value="">Pilih Item Part</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="Customer" name="customer" value="{{ $data->customer }}" readonly>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="nospk" class="col-sm-3 col-form-label form-label">No. SPK</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="nospk" name="no_spk" value="{{ $data->no_spk }}" readonly>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="estimasijam" name="estimasi_jam">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="actualjam" class="col-sm-3 col-form-label form-label">Actual Jam</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="actualjam" name="actual_jam">
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" class="form-control" id="targetfinish" name="target_finish">
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mt-4">
                                <div class="col-sm-9 offset-sm-3">
                                    <button type="button" class="btn btn-danger btn-custom me-2">BATAL</button>
...
$(document).ready(function() {
    $('#project').change(function() {
        ...
        if(selectedProject) {
            $.ajax({
                url: '/getItemParts/' + selectedProject,
                type: "GET",
                dataType: "json",
                success:function(data) {
                    $('#itemPart').empty();
                    $('#itemPart').append('<option value="">Pilih Item Part</option>');
                    $.each(data, function(key, value) {
                        $('#itemPart').append('<option value="'+ value.item_part +'">'+ value.item_part +'</option>');
                    });
                }
            });
        } else {
