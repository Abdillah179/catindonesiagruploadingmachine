    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <h2 class="mb-4 judul-h2">Tambah Gambar Drawing SPK Ke PPIC Plant 1</h2>
                <!-- Konten card tetap sama -->

                <div class="row row-card">
                    @if (session('kirim_gambar_berhasil'))
                    <div class="alert alert-primary alert-dismissible fade show" role="alert">
                        <strong>{{ session('kirim_gambar_berhasil') }}</strong>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                      </div>
                    @endif
                    <div class="col-12 col-md-8 col-lg-12 mb-4">
                        @foreach($dataimagedrawing as $dt)
                        <div class="image-container">
                          ...
                          <div class="image mt-5">
                            ...
                            <form action="/kirimgambardrawingtoppicplant1/pt1/{{ $dt->url_unique_gambar }}" method="post">
                                @csrf

                                <button type="submit" class="btn btn-primary btn-sm mb-3">Kirim Gambar Drawing Ke Plant 1</button>
                            </form>
                          </div>
                       </div>
                       @endforeach
