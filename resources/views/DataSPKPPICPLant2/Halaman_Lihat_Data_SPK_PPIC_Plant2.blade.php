    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <h2 class="mb-4 judul-h2">Lihat Data SPK Plant 2</h2>
                    ...
                    <div class="col-12 mb-5">
                        <div class="card">
                            <div class="card-header">
                                <form action="/lihatdataspkbagianppicplant3">
                                    ...
                                    <tbody class="tabel-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="/lihatgambardrawingspkterkirimkeppicplant2/pt2/{{ $dt->url_unique }}" class="btn btn-primary btn-sm mt-3">Lihat Gambar Drawing Terkirim</a>
                                                <a href="/tambahdrawingspkppicplant2/pt2/{{ $dt->url_unique }}" class="btn btn-primary btn-sm mt-3">Tambah Drawing SPK Plant 2</a>
                                            </td>
                                        </tr>
                                        <?php $no++;?>
                                        @endforeach
