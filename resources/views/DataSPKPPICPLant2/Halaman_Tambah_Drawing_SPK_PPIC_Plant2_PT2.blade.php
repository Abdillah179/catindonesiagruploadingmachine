    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <h2 class="mb-4 judul-h2">Tambah Gambar Drawing SPK Ke PPIC Plant 2</h2>
                <!-- Konten card tetap sama -->

                <div class="row row-card">
                    @if (session('kirim_gambar_berhasill'))
                    <div class="alert alert-primary alert-dismissible fade show" role="alert">
                        <strong>{{ session('kirim_gambar_berhasill') }}</strong>
                    ...
                    <div class="col-12 col-md-8 col-lg-12 mb-4">
                        ...
                        <div class="image-container">
                          ...
                          <div class="image mt-5">
                            ...
                            <form action="/kirimgambardrawingtoppicplant2/pt2/{{ $dt->url_unique_gambar }}" method="post">
                                @csrf

                                <button type="submit" class="btn btn-primary btn-sm mb-3">Kirim Gambar Drawing Ke Plant 2</button>
                            </form>
                          </div>
                       </div>
                       @endforeach
