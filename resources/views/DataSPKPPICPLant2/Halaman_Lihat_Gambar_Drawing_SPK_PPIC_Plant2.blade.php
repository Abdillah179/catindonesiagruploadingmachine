        ...
        <div class="row">
            ...
            <div id="sidebar" class="col-md-2 sidebar d-none d-md-block">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link active" href="/lihatdataspkbagianppicplant2">Lihat Data SPK Plant 2</a>
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <h2 class="mb-4 judul-h2">Lihat Gambar Drawing SPK Terkirim Ke Plant 2</h2>
                <!-- Konten card tetap sama -->

                <div class="row row-card">
                    @if (session('Hapus_Gambar_Berhasill'))
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        <strong>{{ session('Hapus_Gambar_Berhasill') }}</strong>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                      </div>
                    @endif
                    <div class="col-12 col-md-8 col-lg-12 mb-4">
                        @foreach($datagambar as $dt)
                        <div class="image-container">
                          ...
                          <div class="image mt-5">
                            ...
                            <form action="/hapusgambardrawingterkirimtoppicplant2/pt2/{{ $dt->url_unique_gambar }}" method="post">
                                @csrf
                                @method('DELETE')
                            ...
                            <a href="/exportjpggambardrawingterkirimtoppicplant2/pt2/{{ $dt->url_unique_gambar }}" class="btn btn-primary btn-sm">Export JPG</a>

                            <a href="/exportpdfgambardrawingterkirimtoppicplant2/pt2/{{ $dt->url_unique_gambar }}" class="btn btn-primary btn-sm">Export PDF</a>
                          </div>
                       </div>
                       @endforeach
                    </div>
