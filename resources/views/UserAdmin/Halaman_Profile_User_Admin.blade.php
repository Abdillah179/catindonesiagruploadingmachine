        ...
        <div class="row">
            ...
            <div id="sidebar" class="col-md-2 sidebar d-none d-md-block">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link active" href="/profileuseradmin">Profile User</a>
                </nav>
                                ...
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body" style="text-align: left">
                                        <form action="/postubahfotoprofileuser/adm" method="post" enctype="multipart/form-data">
                                            @csrf 
                                            @method('PATCH')
                                    ...
                                    <div class="modal-footer">
                                        <div class="container">
                                            ...
                                            <button type="button" class="btn btn-primary btn-sm btn-block mb-5" id="takefotouseradmin" style="display: none;">Take Foto</button>
                                        </div>
                                    </div>
                                  </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            $('#ambilfoto').click(function(e) {
                ...
                $('#ambilfoto').toggle();
                $('#takefotouseradmin').toggle();
            });
        });

        $('#takefotouseradmin').click(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '/postgetfotoprofileuseradmin',
                data: {
                    _token: '{{ csrf_token() }}',
                    image: image
                },
                ...
                success: function(respond) {
                    if (respond == 1) {
                        ...
                        setTimeout("location.href='/profileuseradmin'", 3000);
                    } else {
