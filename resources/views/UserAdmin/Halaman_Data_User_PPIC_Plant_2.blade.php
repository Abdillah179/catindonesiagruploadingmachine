...
<body>
        ...
        <div class="row">
            ...
            <div id="sidebar" class="col-md-2 sidebar d-none d-md-block">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link active" href="/datauserppicplant2">Data User PPIC Plant 2</a>
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <h2 class="mb-4">Data User PPIC Plant 2</h2>
                ...
                <div class="row row-card">
                    ...
                    @if(session('PostDeleteDataUserPPICPlant2ADM'))
                    <div class="alert alert-primary alert-dismissible fade show" role="alert">
                        <strong>{{ session('PostDeleteDataUserPPICPlant2ADM') }}</strong>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    @endif

                    @if(session('PostTambahDataUserPPICPlant2ADM'))
                    <div class="alert alert-primary alert-dismissible fade show" role="alert">
                        <strong>{{ session('PostTambahDataUserPPICPlant2ADM') }}</strong>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    @endif

                    <div class="col-12 col-md-8 col-lg-12 mb-4">
                        <form action="/datauserppicplant2" method="GET">
                    ...
                    <div class="col-12 col-md-8 col-lg-12 mb-4">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            <i class="fa-solid fa-plus"></i> Tambah Data User PPIC Plant 2
                        </button>
                        
                        <h5 class="mt-4">Jumlah Data : {{ $datauserppicplant2count }}</h5>
                        <!-- Modal -->
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Data User PPIC Plant 2</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form action="/posttambahdatauserppicplant2/adm" method="post" enctype="multipart/form-data">
                                        @csrf
                                        @method('POST')
                                        ...
                                        <div class="mb-3">
                                          ...
                                          <input type="text" class="form-control" id="exampleInputPlant" name="plant" value="Plant 2" readonly>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="imageppicplant2" class="form-label">Pas Foto</label>

                                            <img class="img-preview img-fluid mb-2">
                                            <input type="file" class="form-control" id="imageppicplant2" name="image" onchange="previewImage()">
                                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <?php $no = 1;?>
                                @foreach($datauserppicplant2 as $index => $dtuserppicplant2)
                              <tr>
                                <td>{{ $datauserppicplant2->firstItem() + $index }}</td>
                                <td>{{ $dtuserppicplant2->nama_user }}</td>
                                <td>{{ $dtuserppicplant2->nik_karyawan }}</td>
                                <td>{{ $dtuserppicplant2->no_telepon }}</td>
                                <td>{{ $dtuserppicplant2->departemen }}</td>
                                <td>{{ $dtuserppicplant2->plant }}</td>
                                <td>{{ $dtuserppicplant2->email }}</td>
            

                                @if($dtuserppicplant2->role == 3)
                                <td>
                                    <span class="badge text-bg-warning"">PPIC PLANT 2</span>
                                </td>
                                @endif

                                <td>
                                    <form action="/postdeletedatauserppicplant2/adm/{{ $dtuserppicplant2->url_unique }}" method="post">
                                        @csrf 
                                        @method('DELETE')
    ...
    <script>
        ...
        function previewImage() {
            const image = document.querySelector('#imageppicplant2');
