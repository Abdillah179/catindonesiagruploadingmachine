...
<body>
        ...
        <div class="row">
            ...
            <div id="sidebar" class="col-md-2 sidebar d-none d-md-block">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link" href="/datauserpelihatdataloadingmachine">Data User Pelihat Data Loading Mesin</a>
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <div class="row row-card">
                    @if(session()->has('PostLoginUserAdmin'))
                    <div class="col-12">
                    ...
                    @endif
                    <div class="col-md-4">
                        <a href="/datamesin" style="text-decoration: none">
                            <div class="card">
                                <div class="card-body">
                                    <span class="card-icon">⚙️</span>
                                    <span>Data Mesin Plant 1</span>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="/datamesinplant2" style="text-decoration: none">
                            <div class="card">
                                <div class="card-body">
                                    <span class="card-icon">⚙️</span>
                                    <span>Data Mesin Plant 2</span>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="/datamesinplant3" style="text-decoration: none">
                            <div class="card">
                                <div class="card-body">
                                    <span class="card-icon">⚙️</span>
                                    <span>Data Mesin Plant 3</span>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="/datauseradmin" style="text-decoration: none">
                            <div class="card">
                                <div class="card-body">
                                    <span class="card-icon">🙎🏻‍♂️</span>
                    ...
                    <div class="col-md-4">
                        <a href="/datauserppicplant1" style="text-decoration: none">
                            <div class="card">
                                <div class="card-body">
                                    <span class="card-icon">🙎🏻‍♂️</span>
                                    <span>Data User PPIC Plant 1</span>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="/datauserppicplant2" style="text-decoration: none">
                            <div class="card">
                                <div class="card-body">
                                    <span class="card-icon">🙎🏻‍♂️</span>
                                    <span>Data User PPIC Plant 2</span>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="/datauserppicplant3" style="text-decoration: none">
                            <div class="card">
                                <div class="card-body">
                                    <span class="card-icon">🙎🏻‍♂️</span>
                                    <span>Data User PPIC Plant 3</span>
                                </div>
                            </div>
                        </a>
                    </div>
    ...
    @php
    $loginsukses = session('PostLoginUserAdmin');
    @endphp
