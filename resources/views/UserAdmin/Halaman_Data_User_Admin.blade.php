...
<body>
        ...
        <div class="row">
            ...
            <div id="sidebar" class="col-md-2 sidebar d-none d-md-block">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link active" href="/datauseradmin">Data User Admin</a>
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <h2 class="mb-4">Data User Admin</h2>
                ...
                <div class="row row-card">
                    ...
                    @if(session('PostTambahDataUserAdminADM'))
                    <div class="alert alert-primary alert-dismissible fade show" role="alert">
                        <strong>{{ session('PostTambahDataUserAdminADM') }}</strong>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    @endif

                    @if(session('PostDeleteDataUserAdminADM'))
                    <div class="alert alert-primary alert-dismissible fade show" role="alert">
                        <strong>{{ session('PostDeleteDataUserAdminADM') }}</strong>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    @endif

                    <div class="col-12 col-md-8 col-lg-12 mb-4">
                        <form action="/datauseradmin" method="GET">
                    ...
                    <div class="col-12 col-md-8 col-lg-12 mb-4">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                            <i class="fa-solid fa-plus"></i> Tambah Data User Admin
                        </button>

                        <h5 class="mt-4">Jumlah Data : {{ $datauseradmincount }}</h5>
                        ...
                        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <h1 class="modal-title fs-5" id="exampleModalLabel">Tambah Data User Admin</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form action="/posttambahdatauseradmin/adm" method="post" enctype="multipart/form-data">
                                        @csrf
                                        @method('POST')
                                        ...
                                        <div class="mb-3">
                                          ...
                                          <input type="text" class="form-control" id="exampleInputDepartemen" name="departemen" value="Admin" readonly>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label for="imageadmin" class="form-label">Pas Foto</label>

                                            <img class="img-preview img-fluid">
                                            <input type="file" class="form-control mt-3" id="imageadmin" name="image" onchange="previewImage()">
                                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                              @foreach($datauseradmin as $index => $dtuseradmin)
                              <tr>
                                <td>{{ $datauseradmin->firstItem() + $index }}</td>
                                <td>{{ $dtuseradmin->nama_user }}</td>
                                <td>{{ $dtuseradmin->nik_karyawan }}</td>
                                <td>{{ $dtuseradmin->no_telepon }}</td>
                                <td>{{ $dtuseradmin->departemen }}</td>
                                <td>{{ $dtuseradmin->plant }}</td>
                                <td>{{ $dtuseradmin->email }}</td>

                                @if($dtuseradmin->role == 1)
                                <td>
                                ...
                                <td>
                                    <form action="/postdeleteuseradmin/adm/{{ $dtuseradmin->url_unique }}" method="post">
                                        @csrf 
                                        @method('DELETE')
    ...
    <script>
        ...
        function previewImage() {
            const image = document.querySelector('#imageadmin');
