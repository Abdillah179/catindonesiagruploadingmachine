...
<body>   
    <main id="container">
        <form id="login_form" action="/postloginuserppicplant1" method="post">
          @csrf
          @method('POST')
            <!-- FORM HEADER -->
            <div id="form_header">
        ...
        @if(session('PostLoginUserPPICPlant1'))
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>{{ session('PostLoginUserPPICPlant1') }}</strong>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
        @endif
        @if(session('PostLoginUserPPICPlant11'))
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>{{ session('PostLoginUserPPICPlant11') }}</strong>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
        @endif
        @if(session('PostLoginUserPPICPlant'))
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>{{ session('PostLoginUserPPICPlant') }}</strong>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
        @endif
        @if(session('PostLoginUserPPICPlant11S'))
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>{{ session('PostLoginUserPPICPlant11S') }}</strong>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
        @endif
            ...
            <div id="inputs">
                ...
                <div class="input-box">
                    ...
                    <div id="forgot_password">
                        <a href="/forgotpasswordppicplant1">
