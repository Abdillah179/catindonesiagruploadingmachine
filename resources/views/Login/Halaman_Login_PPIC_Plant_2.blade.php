...
<body>   
    <main id="container">
        <form id="login_form" action="/postloginuserppicplant2" method="post">
          @csrf
          @method('POST')
            <!-- FORM HEADER -->
            <div id="form_header">
        ...
        @if(session('PostLoginUserPPICPlant2Gagal'))
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>{{ session('PostLoginUserPPICPlant2Gagal') }}</strong>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
        @endif
        @if(session('PostLoginUserPPICPlant2Gagall'))
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>{{ session('PostLoginUserPPICPlant2Gagall') }}</strong>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
        @endif
        @if(session('PostLoginUserPPICPlant2Gagalll'))
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>{{ session('PostLoginUserPPICPlant2Gagalll') }}</strong>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
        @endif
        @if(session('PostLoginUserPPICPlant2'))
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>{{ session('PostLoginUserPPICPlant2') }}</strong>
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
        @endif
            <!-- INPUTS -->
            <div id="inputs">
                ...
                <div class="input-box">
                    ...
                    <div id="forgot_password">
                        <a href="/forgotpasswordppicplant2">
