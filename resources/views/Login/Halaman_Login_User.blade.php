...
<body>   
    <main id="container">
        <form id="login_form" action="/postloginuseradmin" method="post">
          @csrf 
          @method('POST')
            <!-- FORM HEADER -->
            <div id="form_header">
        ...
        @if(session('PostLoginUserAdmin'))
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
          <strong>{{ session('PostLoginUserAdmin') }}</strong>
          <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
        @endif
        @if(session('PostLoginUserAdminGagal'))
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
          <strong>{{ session('PostLoginUserAdminGagal') }}</strong>
          <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
        @endif
        @if(session('PostLoginUserAdminGagall'))
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
          <strong>{{ session('PostLoginUserAdminGagal') }}</strong>
          <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
        @endif
        @if(session('PostLoginUserAdminn'))
        <div class="alert alert-danger alert-dismissible fade show" role="alert">
          <strong>{{ session('PostLoginUserAdminn') }}</strong>
          <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
        </div>
        @endif
                ...
                <div class="input-box">
                    <label for="password">
                        ...
                        <div class="input-field">
                            ...
                            <input type="password" id="password" placeholder="Masukkan Password Anda" required name="password">
                        </div>
                    </label>
