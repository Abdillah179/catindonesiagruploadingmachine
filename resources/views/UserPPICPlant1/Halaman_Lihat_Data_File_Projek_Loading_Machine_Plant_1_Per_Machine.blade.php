...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <h2 class="mb-4">Lihat File Projek</h2>
                ...
                <div class="row row-card">
                    ...
                    @if(session()->has('PostTambahDataFileProjekLoadingMachinePerMachinePlant1PLNT1'))
                    <div class="col-12">
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            <strong>{{ session('PostTambahDataFileProjekLoadingMachinePerMachinePlant1PLNT1') }}</strong>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    </div>
                    @endif

                    @if(session()->has('PostDeleteFileProjekLoadingMachinePerMachinePlant1PLNT1'))
                    <div class="col-12">
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            <strong>{{ session('PostDeleteFileProjekLoadingMachinePerMachinePlant1PLNT1') }}</strong>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    </div>
                    @endif

                    @if(session()->has('PostUbahDataFileProjekLoadingMachinePerMachinePlant1PLNT1'))
                    <div class="col-12">
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            <strong>{{ session('PostUbahDataFileProjekLoadingMachinePerMachinePlant1PLNT1') }}</strong>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="col-12 mb-5">
                        <div class="card">
                            <div class="card-header">
                                <form action="/lihatdatafileprojekloadingmachinepermachineplant1/plnt1/{{ $data->url_unique }}">
                    ...
                    <div class="col-md-12">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalTambahFileProjekLoadingMesinPerMesinPlant1PLANT1">
                            Tambah File Projek
                        </button>
                        
                        <!-- Modal -->
                        <div class="modal fade" id="exampleModalTambahFileProjekLoadingMesinPerMesinPlant1PLANT1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/posttambahdatafileprojekloadingmachinepermachineplant1/PLNT1/{{ $data->url_unique }}" method="POST" enctype="multipart/form-data">
                                            @csrf 
                                            @method('POST')
                        ...
                        @foreach($datafileprojek as $dtfileprojek)
                            <div class="image-container">
                                ...
                                <div class="image mb-5 mt-2">
                                    <form action="/postdeletefileprojekloadingmachinepermachineplant1/PLNT1/{{ $dtfileprojek->url_unique }}" method="post" class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalUbahDataFileProjekLoadingMachinePerMachinePlant1PLANT1{{ $dtfileprojek->url_unique }}" style="margin-bottom: 60px;">
                                        Ubah File
                                    </button>


                                    <div class="modal fade" id="exampleModalUbahDataFileProjekLoadingMachinePerMachinePlant1PLANT1{{ $dtfileprojek->url_unique }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                          <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body">
                                                <form action="/postubahdatafileprojekloadingmachinepermachineplant1/PLNT1/{{ $dtfileprojek->url_unique }}" method="post" enctype="multipart/form-data">
                                                    @csrf 
                                                    @method('PATCH')
    ...
    @php
    $loginsukses = session('PostLoginUserPPICPlant111');
    $loginsukses1 = session('VerifyEmailPPICPlant1');
    @endphp

    <script>
        gsap.registerPlugin(TextPlugin)

        const loginMessage = '{{  $loginsukses }}';
    ...
    <script>
        ...
        const loginMessage1 = '{{  $loginsukses1 }}';

        gsap.to('.text-alert-1', {
            duration: 5,
            delay: 1,
            text: loginMessage1
        });
