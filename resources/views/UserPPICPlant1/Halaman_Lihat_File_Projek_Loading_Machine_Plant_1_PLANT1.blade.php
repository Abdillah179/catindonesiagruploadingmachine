        ...
        <div class="row">
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <div class="row row-card">
                    ...
                    @if(session()->has('PostTambahDataFileProjekLoadingMachinePlant1PLNT1'))
                    <div class="col-12">
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            <strong>{{ session('PostTambahDataFileProjekLoadingMachinePlant1PLNT1') }}</strong>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    </div>
                    @endif

                    @if(session()->has('PostDeleteFileProjekLoadingMachinePlant1PLNT1'))
                    <div class="col-12">
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            <strong>{{ session('PostDeleteFileProjekLoadingMachinePlant1PLNT1') }}</strong>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    </div>
                    @endif

                    @if(session()->has('PostUbahDataFileProjekLoadingMachinePlant1PLANT1'))
                    <div class="col-12">
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            <strong>{{ session('PostUbahDataFileProjekLoadingMachinePlant1PLANT1') }}</strong>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="col-12 mb-5">
                        <div class="card">
                            <div class="card-header">
                                <form action="/lihatfileprojekloadingmachineplant1/plant1/{{ $data->url_unique }}">
                    ...
                    <div class="col-md-12">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalTambahFileProjekLoadingMesinKeseluruhanPlant1PLANT1">
                            Tambah File Projek
                        </button>
                        
                        <!-- Modal -->
                        <div class="modal fade" id="exampleModalTambahFileProjekLoadingMesinKeseluruhanPlant1PLANT1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="/posttambahdatafileprojekloadingmachineplant1/PLNT1/{{ $data->url_unique }}" method="POST" enctype="multipart/form-data">
                                            @csrf 
                                            @method('POST')
                        ...
                        @foreach($datafileprojek as $dtfileprojek)
                            <div class="image-container">
                                ...
                                <div class="image mb-5 mt-2">
                                    <form action="/postdeletefileprojekloadingmachineplant1/PLNT1/{{ $dtfileprojek->url_unique }}" method="post" class="d-inline">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    <!-- Button trigger modal -->
                                    <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalUbahDataFileProjekLoadingMachinePlant1PLANT1{{ $dtfileprojek->url_unique }}" style="margin-bottom: 60px;">
                                        Ubah File
                                    </button>
                                    
                                    <!-- Modal -->
                                    <div class="modal fade" id="exampleModalUbahDataFileProjekLoadingMachinePlant1PLANT1{{ $dtfileprojek->url_unique }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <form action="/postubahdatafileprojekloadingmachineplant1/plant1/{{ $dtfileprojek->url_unique }}" method="post" enctype="multipart/form-data">
                                                        @csrf 
                                                        @method('PATCH')
