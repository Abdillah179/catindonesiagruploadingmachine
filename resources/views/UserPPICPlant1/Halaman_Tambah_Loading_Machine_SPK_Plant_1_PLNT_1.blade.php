        ...
        <div class="row">
            ...
            <div id="sidebar" class="col-md-2 sidebar d-none d-md-block">
                ...
                <nav class="nav flex-column">
                    ...
                    @can('ppicplant1gate')
                    <a class="nav-link active" href="/tambahloadingmachinesistemplant1/plnt1">Tambah Loading Machine Plant 1</a>
                    @endcan
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <div class="row">
                    @if(session('PostTambahDataLoadingMachineSPKPPICPlant1PLNT1'))
                        <div class="col-12 col-md-8 col-lg-12 mb-4">
                            <div class="alert alert-primary alert-dismissible fade show" role="alert">
                                <strong>{{ session('PostTambahDataLoadingMachineSPKPPICPlant1PLNT1') }}</strong>
                ...
                <h2 class="mb-4 judul-h2">Tambah Loading Machine Plant 1</h2>
                ...
                <div class="row row-card">
                    ...
                    <div class="col-12 col-md-8 col-lg-12 mb-4">
                        <form action="/posttambahdataloadingmesinspkppicplant1/plnt1" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            ...
                            <div class="row mb-3 machine">
                                ...
                                <div class="col-sm-9">
                                    <input type="hidden" class="form-control" id="urlunique" name="url_unique_data_mesin" readonly>
                                </div>
                            </div>
                            <div class="row mb-3">
