...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <h2 class="mb-4 judul-h2">Detail Loading Mesin</h2>
                ...
                <div class="row row-card">
                    <div class="col-12 mb-5">
                        <div class="card">
                            <div class="card-header">
                                <form action="/lihatdetaildataloadingmachineplant1/plnt1/{{ $mesin->url_unique_mesin }}">
                                    ...
                                    <div class="row align-items-end mt-3">
                                        ...
                                        <div class="col-md-2 mb-3">
                                            ...
                                            <a href="/lihatdetaildataloadingmachineplant1/plnt1/{{ $mesin->url_unique_mesin }}" class="btn btn-warning mt-4">Clear</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                    ...
                    @if(session('PostEditDataDetailLoadingMesinPPICPlant1PLNT1'))
                    <div class="alert alert-primary alert-dismissible fade show" role="alert">
                        <strong>{{ session('PostEditDataDetailLoadingMesinPPICPlant1PLNT1') }}</strong>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    @endif

                    @if(session('PostUpdateStatusDoneDetailDataLoadingMesinPlant1PLNT1'))
                    <div class="alert alert-primary alert-dismissible fade show" role="alert">
                        <strong>{{ session('PostUpdateStatusDoneDetailDataLoadingMesinPlant1PLNT1') }}</strong>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    @endif
                    
                    @if(session('PostTambahDataFileProjekLoadingMachinePerMachinePlant1'))
                    <div class="alert alert-primary alert-dismissible fade show" role="alert">
                        <strong>{{ session('PostTambahDataFileProjekLoadingMachinePerMachinePlant1') }}</strong>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    @endif
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="/lihatdatafileprojekloadingmachinepermachineplant1/plnt1/{{ $dtloadingmesin->url_unique }}" class="btn btn-primary btn-sm">Lihat File Projek</a>

                                            @else

                                            <!-- Button trigger modal -->
                                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalTambahDataFileProjekLoadingMachinePerMachinePlant1PLANT1{{ $dtloadingmesin->url_unique }}">
                                                    Tambah File Projek
                                                </button>
                                                
                                                <!-- Modal -->
                                                <div class="modal fade" id="exampleModalTambahDataFileProjekLoadingMachinePerMachinePlant1PLANT1{{ $dtloadingmesin->url_unique }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="/posttambahdatafileprojekloadingmachinepermachineplant1/{{ $dtloadingmesin->url_unique }}" method="post" enctype="multipart/form-data">
                                                                    @csrf 
                                                                    @method('POST')
                                        ...
                                        @can('ppicplant1gate')
                                        <td>
                                            <form action="/postdeletedatadetailloadingmachineplant1/plnt1/{{ $dtloadingmesin->url_unique }}" method="post" class="d-inline">
                                                @csrf 
                                                @method('DELETE')
                                             ...
                                             <!-- Button trigger modal -->
                                             <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalEditDataDetailLoadingMachineSPKPlant1PLNT1{{ $dtloadingmesin->url_unique }}">
                                                Edit Loading Machine
                                            </button>
                                            
                                            <!-- Modal -->
                                            <div class="modal fade" id="exampleModalEditDataDetailLoadingMachineSPKPlant1PLNT1{{ $dtloadingmesin->url_unique }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="/posteditdatadetailloadingmesinppicplant1/plnt1/{{ $dtloadingmesin->url_unique }}" method="post" class="d-inline">
                                                            @csrf
                                                            @method('PATCH')
                                            ...
                                            <form action="/postupdatestatusdonedetaildataloadingmesinplant1/plnt1/{{ $dtloadingmesin->url_unique }}" method="post" class="d-inline">
                                                @csrf 
                                                @method('PATCH')

                                                <button type="submit" class="btn btn-primary btn-sm mt-3">Update Status Done Loading Machine</button>
                                            </form>
                                        </td>
                                        @endcan
                                    </tr>
    ...
    <script>
        function exportPDF() {
            ...
            let url = "/exportpdfdatadetailloadingmachineplant1/{{ $mesin->url_unique_mesin }}";
   ...
   <script>
        function exportExcel() {
            ...
            let endDate = document.querySelector('input[name="end_date"]').value; // Ganti dengan selector yang sesuai
            let statusFilter = document.querySelector('select[name="opsi_filter"]').value; // Ganti dengan selector yang sesuai
            let url = "/exportexceldatadetailloadingmachineplant1/{{ $mesin->url_unique_mesin }}";
