...
<body>
        ...
        <div class="row">
            ...
            <div id="sidebar" class="col-md-2 sidebar d-none d-md-block">
                ...
                <nav class="nav flex-column">
                    <a class="nav-link active" href="/DashboardPPICPlant1">Dashboard</a>
                    @can('ppicplant1gate')
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <h2 class="mb-4">Dashboard PPIC Plant 1</h2>
                <!-- Konten card tetap sama -->

                <div class="row row-card">
                    @if(session()->has('PostLoginUserPPICPlant111'))
                    <div class="col-12">
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            <span class="alert-text"><strong class="text-alert"></strong></span>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    </div>
                    @endif
                    @if(session()->has('VerifyEmailPPICPlant1'))
                    <div class="col-12">
                        <div class="alert alert-primary alert-dismissible fade show" role="alert">
                            <span class="alert-text"><strong class="text-alert text-alert-1"></strong></span>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                    </div>
                    @endif
                    <div class="col-md-4">
                        <a href="/pilihopsilihatdataloadingmachineplant2/pln1" style="text-decoration: none">
                            <div class="card">
                                <div class="card-body">
                                    <span class="card-icon">📁</span>
                                    <span>Lihat Data Loading Machine Plant 2</span>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="/pilihopsilihatdataloadingmachineplant3/plant1" style="text-decoration: none">
                            <div class="card">
                                <div class="card-body">
                                    <span class="card-icon">📁</span>
                    ...
                    @can('ppicplant1gate')
                    <div class="col-md-4">
                        <a href="/tambahloadingmachinesistemplant1/plnt1" style="text-decoration: none">
                            <div class="card">
                                <div class="card-body">
                                    <span class="card-icon">📁</span>
                    ...
                    @endcan
                    <div class="col-md-4">
                        <a href="#" data-bs-toggle="modal" data-bs-target="#loadingMachineModal" style="text-decoration: none">
                            <div class="card">
                                <div class="card-body">
                                    <span class="card-icon">📁</span>
                                    <span>Lihat Semua Data Loading Machine Plant 1</span>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="modal fade" id="loadingMachineModal" tabindex="-1" aria-labelledby="loadingMachineModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="loadingMachineModalLabel">Pilih Opsi Lihat Data Loading Machine</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                  <form action="/lihatdataloadingmesinplant1" method="get">
                                    <select class="form-select" aria-label="Default select example" name="lihat_data_loading_machine_pl_1">
                                        <option selected>Pilih Opsi</option>
                                        <option value="Lihat Data Loading Machine Per Mesin">Lihat Data Loading Machine Per Mesin</option>
                                        <option value="Lihat Data Keseluruhan Loading Machine">Lihat Data Keseluruhan Loading Machine</option>
                                      </select>
    ...
    @if(session('PostLoginUserPPICPlant111'))
        document.addEventListener('DOMContentLoaded', function() {
