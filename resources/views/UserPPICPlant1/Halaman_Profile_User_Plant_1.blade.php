        ...
        <div class="row">
            ...
            <div id="sidebar" class="col-md-2 sidebar d-none d-md-block">
                ...
                <nav class="nav flex-column">
                    ...
                    @can('ppicplant1gate')
                    <a class="nav-link active" href="/profileuserpl1">Profile User</a>
                    @endcan
                                    ...
                                    <div class="modal-dialog">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-body" style="text-align: left">
                                            <form action="/postubahfotoprofileuser/plnt1" method="post" enctype="multipart/form-data">
                                                @csrf 
                                                @method('PATCH')
            ...
            $.ajax({
                ...
                success: function(respond) {
                    if (respond == 1) {
                        ...
                        setTimeout("location.href='/profileuserpl1'", 3000);
                    } else {
