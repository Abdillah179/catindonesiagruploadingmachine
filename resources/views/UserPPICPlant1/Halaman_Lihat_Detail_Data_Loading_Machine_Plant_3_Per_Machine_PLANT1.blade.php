...
<body>
        ...
        <div class="row">
            ...
            <div id="sidebar" class="col-md-2 sidebar d-none d-md-block">
                ...
                <nav class="nav flex-column">
                    ...
                    <a class="nav-link" href="/pilihopsilihatdataloadingmachineplant3plant1">Lihat Semua Data Loading Machine Plant 1</a>
                    ...
                    @can('ppicplant1gate')
                    <a class="nav-link" href="/restoredataloadingmachineplant3plant1/pln1">Restore Data Loading Machine</a>
                    @endcan
                    
                    <a class="nav-link" href="/pilihopsilihatdataloadingmachineplant3plant2/pln1">Lihat Data Loading Machine Plant 2</a>
                    
                    <a class="nav-link active" href="/pilihopsilihatdataloadingmachineplant3/plant1">Lihat Data Loading Machine Plant 3</a>
            ...
            <div id="mainContent" class="col-md-10 main-content">
                ...
                <h2 class="mb-4 judul-h2">Data Loading Mesin {{ $mesin->nama_mesin }} Plant 3</h2>
                    ...
                    <div class="col-12 mb-5">
                        <div class="card">
                            <div class="card-header">
                                <form action="/lihatdetaildataloadingmachineplant3/plant1/{{ $mesin->url_unique_mesin }}">
                                    ...
                                    <div class="row align-items-end mt-3">
                                        ...
                                        <div class="col-md-2 mb-3">
                                            ...
                                            <a href="/lihatdetaildataloadingmachineplant3/plant1/{{ $mesin->url_unique_mesin }}" class="btn btn-warning mt-4">Clear</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    @foreach($dataloadingmachineplant3 as $index => $dtloadingmesin)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @if($datafileprojek)
                                                ...
                                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModalLihatDataFileProjekLoadingMachinePerMesinPlant3PLANT1{{ $dtloadingmesin->url_unique }}">
                                                    Lihat File Projek
                                                </button>
                                                
                                                <!-- Modal -->
                                                <div class="modal fade" id="exampleModalLihatDataFileProjekLoadingMachinePerMesinPlant3PLANT1{{ $dtloadingmesin->url_unique }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-xl modal-dialog-scrollable">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                @foreach($dtloadingmesin->fileProjekLoadingMachinePlant3 as $dtfileprojek)
    ...
    <script>
        function exportPDF() {
            ...
            let url = "/exportpdfdatadetailloadingmesinplant3permesin/plant1/{{ $mesin->url_unique_mesin }}";
   ...
   <script>
        function exportExcel() {
            ...
            let endDate = document.querySelector('input[name="end_date"]').value; // Ganti dengan selector yang sesuai
            let statusFilter = document.querySelector('select[name="opsi_filter"]').value; // Ganti dengan selector yang sesuai
            let url = "/exportexceldatadetailloadingmesinplant3permesin/plant1/{{ $mesin->url_unique_mesin }}";
