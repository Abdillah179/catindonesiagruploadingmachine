...
<body>   
    <main id="container">
        <form id="login_form" action="{{ route('password.update') }}" method="post">
          @csrf
          @method('POST')
            <!-- FORM HEADER -->
            <div id="form_header">
            ...
            <div id="inputs">
              ...
              <div class="input-box">
                <label for="password2">
                    ...
                    <div class="input-field">
                        <i class="fa-solid fa-key"></i>
                        <input type="password" id="password2" placeholder="Konfirmasi Password" name="password_confirmation">
                    </div>
                </label>
              </div>
            </div>
