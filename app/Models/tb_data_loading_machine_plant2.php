...
class tb_data_loading_machine_plant2 extends Model
{
    ...
    public function tb_data_mesin_plant2()
    {
        return $this->belongsTo(tb_data_mesin_plant_2::class, 'url_unique_data_mesin', 'url_unique_mesin');
    }
    
    public function fileProjekLoadingMachinePlant2()
    {
        return $this->hasMany(tb_data_file_projek_loading_machine_plant_2::class, 'url_unique_loading_machine', 'url_unique');
    }
}
