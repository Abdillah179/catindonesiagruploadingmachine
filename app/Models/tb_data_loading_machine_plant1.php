...
class tb_data_loading_machine_plant1 extends Model
{
    ...
    public function tb_data_mesins()
    {
        return $this->belongsTo(tb_data_mesin::class, 'url_unique_data_mesin', 'url_unique_mesin');
    }
    
    public function fileProjek()
    {

        return $this->hasMany(tb_data_file_projek_loading_machine_plant_1::class, 'url_unique_loading_machine', 'url_unique');
    }
}
